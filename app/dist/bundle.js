...
/***/ function(module, exports, __webpack_require__) {
	...
	var balanceReducer = function (state, action) {
	    if (state === void 0) { state = initialState.balance; }
	    switch (action.type) {
	        case 1 /* DEPOSIT_INTO_ACCOUNT */:
	            return state + action.amount;
	        case 0 /* WITHDRAW_FROM_ACCOUNT */:
	            return state - action.amount;
	        default:
	            return state;
	    }
	...
	var uiReducer = function (state, action) {
	    if (state === void 0) { state = initialState.ui; }
	    switch (action.type) {
	        case 2 /* TOGGLE_EXCHANGE */:
	            return update(state, { showExchange: { $apply: function (currentState) { return !currentState; } } });
	        default:
	            return state;
	    }
	};
	var bankReducer = redux_1.combineReducers({ balance: balanceReducer, ui: uiReducer });
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    BankApp.prototype.render = function () {
	        return (React.createElement("div", null, 
	            React.createElement("header", null, 
	                React.createElement("img", {src: "//www.pro-react.com/logos/redux-bank.svg", width: "150", height: "150"}), 
	            ...
	            React.createElement("div", {className: "info", onClick: this.props.onToggle}, 
	                React.createElement("strong", null, "Additional Info:"), 
	                React.createElement("div", {className: this.props.showExchange ? 'info--visible' : 'info--closed'}, 
	                    React.createElement("p", null, 
	                        React.createElement("strong", null, "Your account Manager:"), 
	                        " C. F. Frost "), 
	                    React.createElement("p", null, 
	                        React.createElement("strong", null, "Pre approved credit limit:"), 
	                        " $500,000.00 ")))));
	    };
	    return BankApp;
	}(React.Component));
	...
	var mapDispatchToProps = function (dispatch) {
	    return {
	        onDeposit: function (amount) { return dispatch(bankActionCreators_1.default.depositIntoAccount(amount)); },
	        onWithdraw: function (amount) { return dispatch(bankActionCreators_1.default.withdrawFromAccount(amount)); },
	        onToggle: function () { return dispatch(bankActionCreators_1.default.toggleExchange()); }
	    };
	};
	var BankAppContainer = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(BankApp);
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports) {
	...
	var bankActionCreators = {
	    depositIntoAccount: function (amount) {
	        return {
	            type: 1 /* DEPOSIT_INTO_ACCOUNT */,
	            amount: amount
	        };
	    },
	    withdrawFromAccount: function (amount) {
	        return {
	            type: 0 /* WITHDRAW_FROM_ACCOUNT */,
	            amount: amount
	        };
	    },
	    toggleExchange: function () {
	        return {
	            type: 2 /* TOGGLE_EXCHANGE */
	        };
	    }
	};
	Object.defineProperty(exports, "__esModule", { value: true });
